  ...
  [
    {
      ...
      title: "Shared incorporation documents",
      summary: "Generators that apply across company types and LLP.",
      order: 0,
      variant: "shared",
    },
    {
